...
mydata <- readMat('../../../examples/robocup/game6.mat')
...
legend("bottomright", legend=c("original ball trajectory", "PrNN prediction", "reduced PrNN prediction"), lwd=4, lty=c(3,1:2), col=c("black", "blue", "red"), cex=1.4)
dev.off()
