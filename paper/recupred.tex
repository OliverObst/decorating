...
\documentclass[preprint,nopreprintline,12pt,times,authoryear]{elsarticle}
...
LRNN are also advantageous considering the time required to train a well
performing model: On average, this takes less than 3 s per series, excluding
file access. The ARIMA experiments were fastest (0.35 s / series), and ESN took
1.24 s / series. LRNN extend the ESN approach with our approach, and take 2.97 s
on average, this time includes the repeated reservoir generations in our
approach. LSTM including hyper parameter selection took 125.4 s / series.% (all
run on an Intel i9-10940X, 3.3GHz, 128GB RAM).
%%% RESULTS (times)
