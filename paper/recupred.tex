...
GPT-4, cf. \cref{regress}) predicts the correct next value for all number
puzzles, but it only finds correct (recursive or closed) formulae only for 10 of
20 number puzzles\opt{long}{ (cf. \cref{chatgpt})}.
