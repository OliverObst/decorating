...
monotonic and invertible, the LRNN learning procedure can, in principle, be
extended to this case. For this, $g$ has to be applied component-wise to
...
We note that, however, the network size reduction procedure (\cref{reduce})
