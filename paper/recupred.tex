...
For feedforward neural networks, the forward-forward algorithm \citep{Hin22} presents an approach to training models without backpropagation but, at least in its current form, is only applicable to the classification of static patterns.
