...
\begin{itemize}
  \item Because of the linear activation, the spectral radius of the reservoir
	...
	increasing (e.g., \cref{exp}). The spectral radius of the reservoir
	weights matrix $W^\mathrm{res}$ remains $1$ all the time because only
	the output weights are learned.
