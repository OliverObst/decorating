...
publicly available at \url{http://github.com/OliverObst/decorating/}.
...
\citep{MO+19} describes a research dataset using some of the released binaries of
...
considering only the $(x,y)$-coordinates of the ball and the 22 players for all 
time points during the so-called \enquote{play-on} mode.
