...
\jmlrheading{1}{2022}{PAGES}{04/22}{PUBLISHED}{meila00a}{Marina Meil\u{a} and Michael I. Jordan}
...
\author{\name Frieder Stolzenburg \email fstolzenburg@hs-harz.de\\ %0000-0002-4037-2445
	\name Sandra Litz\opt{long}{ \email litz\_sandra@web.de}\\ %0009-0000-8147-4424
	\addr Department of Automation and Computer Sciences,
	Harz University of Applied Sciences,
	38855 Wernigerode, Germany
\AND	
	\name Olivia Michael\opt{long}{ \email olivia\_michael@hotmail.com}\\ %0000-0002-5719-2299
	\name Oliver Obst \email o.obst@westernsydney.edu.au\\ %0000-0002-8284-2062
...
\subsection{\opt{long}{Reinforcement Learning and }Autoregression}\label{regress}

\opt{long}{In \emph{reinforcement learning}~\citep{SB18}, which is concerned
with how software agents ought to take actions in an environment so as to
maximize some notion of cumulative reward, several opportunities to use RNNs
exist: In model-based reinforcement learning, RNNs can be used to learn a model
of the environment. Alternatively, a value function can also be learned directly
from current observations and the state of the RNN as a representation of the
recent history of observations. A consequence of an action in reinforcement
learning may follow the action with a significant delay. This is also called the
temporal credit assignment problem. RNN used for value functions in
reinforcement learning are commonly trained using truncated backpropagation
through time which can be problematic for credit assignment~\citep{PGL17}.}
...
\opt{long}{\begin{remk}
For $N \to \infty$, the formula $f(t) = x_1\,{\lambda_1}^t\,v_1 + \dots +
x_N\,{\lambda_N}^t\,v_N$ restricted to one of the output dimensions can be seen
as an approximation of a \emph{general Dirichlet series}. Note that, according
to \cref{general}, the parameter $t$ may be real and even complex as in general
Dirichlet series. This point of view allows us yet another characterization of
the functions computed by RNNs.
\end{remk}}
...
\begin{itemize}
  \item In the presence of linear activation, the spectral radius of the
	...
	Otherwise, with increasing $t$, the values of $f(t) = W^t \cdot s$ explode if the
...
\begin{center}
	\url{https://github.com/OliverObst/decorating/}
\end{center}
...
\begin{figure}
        \centering
	\includegraphics[width=0.55\textwidth]{fig/parasin2} % height=5cm,
...
%%% more systematic evaluation; methods and tools used; interpretation
Example \#12 has three rather small frequencies and is
	thus difficult also for LRNNs.
...
\begin{sidewaystable}
  ...
  \begin{tabular}{c*{8}{p{8mm}}cccc@{\,+\,}cccc}
	...
	\bottomrule
  \end{tabular}
\caption{Evaluation results for 20 generalized MSO examples with 8 randomly generated frequencies each.}
\end{sidewaystable}
...
top-five teams (available from \url{https://bitbucket.org/oliverobst/robocupsimdata}),
...
\begin{figure}
\begin{minipage}[t]{0.48\textwidth}
 % \includegraphics[width=\textwidth]{fig/Airbus_ARIMA.pdf} % ,height=5.5cm
...
\end{minipage}
  \hfill%
\begin{minipage}[t]{0.48\textwidth}
 % \includegraphics[width=\textwidth]{fig/Airbus_LRNN.pdf} % ,height=5cm
...
\toprule
\multicolumn{2}{c}{company} & \head{mean} & Baseline & ARIMA & ESN & LSTM & \multicolumn{2}{l}{LRNN}\\
name & stock & \head{training} & RMSE & RMSE & RMSE & RMSE & $N$ & RMSE\\ \midrule
Adidas & ADS.DE & 280.8500 & 0.0554 & 0.0554 & 0.0784 & 0.1162 & 2 & 0.0569\\
Airbus & AIR.DE & 99.6260 & 0.0618 & 0.1070 & 0.0583 & 0.2293 & 2 & 0.0500\\
Allianz & ALV.DE & 188.3300 & 0.0252 & 0.0241 & 0.0199 & 0.0916 & 2 & 0.0503\\
BASF & BAS.DE & 59.9500 & 0.0438 & 0.0262 & 0.0739 & 0.1218 & 2 & 0.0433\\
Bayer & BAYN.DE & 47.8990 & 0.0414 & 0.0409 & 0.0626 & 0.1027 & 1 & 0.0350\\
BMW St & BMW.DE & 72.4980 & 0.0706 & 0.0706 & 0.0744 & 0.1509 & 11 & 0.0787\\
Brenntag & BNR.DE & 71.4050 & 0.0544 & 0.0938 & 0.0664 & 0.1162 & 2 & 0.0969\\
Continental & CON.DE & 110.3400 & 0.0518 & 0.0518 & 0.0803 & 0.2540 & 2 & 0.1918\\
Covestro & COV1.DE & 50.1070 & 0.0488 & 0.0488 & 0.0564 & 0.1612 & 1 & 0.0609\\
Deutsche Börse & DB1.DE & 135.9100 & 0.0307 & 0.0307 & 0.0249 & 0.0814 & 1 & 0.0347\\
Deutsche Bank & DBK.DE & 10.0720 & 0.0442 & 0.0442 & 0.0229 & 0.1794 & 1 & 0.0599\\
Delivery Hero & DHER.DE & 116.7200 & 0.1119 & 0.1040 & 0.1148 & 0.2226 & 3 & 0.0798\\
Deutsche Post & DPW.DE & 46.5780 & 0.0487 & 0.0379 & 0.0369 & 0.1822 & 1 & 0.0549\\
Deutsche Telekom & DTE.DE & 15.5660 & 0.0279 & 0.0279 & 0.0619 & 0.1209 & 2 & 0.0224\\
Deutsche Wohnen SE & DWNI.DE & 45.8590 & 0.2410 & 0.2410 & 0.2468 & 0.1706 & 1 & 0.2589\\
Siemens Energy & ENR.DE & 26.2940 & 0.0457 & 0.0457 & 0.0364 & 0.2212 & 9 & 0.0349\\
E.ON & EOAN.DE & 9.0860 & 0.0646 & 0.0646 & 0.0666 & 0.4041 & 1 & 0.0389\\
Fresenius Medical Care & FME.DE & 63.4290 & 0.0831 & 0.0842 & 0.0916 & 0.1279 & 1 & 0.0738\\
Fresenius & FRE.DE & 38.8670 & 0.1256 & 0.1256 & 0.1560 & 0.1399 & 2 & 0.1228\\
HeidelbergCement & HEI.DE & 64.7440 & 0.0504 & 0.0259 & 0.0708 & 0.1171 & 2 & 0.0912\\
Henkel Vz & HEN3.DE & 84.8720 & 0.0476 & 0.0476 & 0.0328 & 0.1479 & 2 & 0.0237\\
HelloFresh & HFG.DE & 71.3430 & 0.1236 & 0.1236 & 0.1241 & 0.3065 & 2 & 0.1220\\
Infineon & IFX.DE & 32.8380 & 0.1035 & 0.1029 & 0.1623 & 0.3574 & 1 & 0.0705\\
Linde PLC & LIN.DE & 229.9400 & 0.1077 & 0.0710 & 0.1134 & 0.1803 & 1 & 0.0909\\
Merck KGaA & MRK.DE & 153.7900 & 0.1293 & 0.0826 & 0.0332 & 0.2156 & 1 & 0.0361\\
MTU Aero Engines & MTX.DE & 198.4500 & 0.0598 & 0.0600 & 0.1085 & 0.2046 & 2 & 0.0652\\
Münchener Rück & MUV2.DE & 225.1500 & 0.0257 & 0.0256 & 0.0430 & 0.1276 & 1 & 0.0421\\
Porsche Vz & PAH3.DE & 73.8450 & 0.0690 & 0.1116 & 0.0920 & 0.1710 & 2 & 0.1188\\
Puma & PUM.DE & 91.3340 & 0.0894 & 0.0887 & 0.0783 & 0.1737 & 1 & 0.0531\\
Qiagen & QIA.DE & 42.4940 & 0.0660 & 0.0660 & 0.0810 & 0.1311 & 2 & 0.0225\\
RWE & RWE.DE & 31.5540 & 0.0460 & 0.0460 & 0.0805 & 0.1202 & 2 & 0.0276\\
SAP & SAP.DE & 110.8400 & 0.0398 & 0.0398 & 0.0459 & 0.1200 & 2 & 0.0442\\
Siemens Healthineers & SHL.DE & 47.7620 & 0.1057 & 0.0561 & 0.0975 & 0.1898 & 1 & 0.0328\\
Siemens & SIE.DE & 127.4800 & 0.0561 & 0.0354 & 0.0758 & 0.1276 & 2 & 0.0996\\
Sartorius Vz & SRT3.DE & 445.1700 & 0.0676 & 0.0676 & 0.0591 & 0.2400 & 1 & 0.0463\\
Symrise & SY1.DE & 108.7900 & 0.1032 & 0.1032 & 0.0893 & 0.1055 & 1 & 0.0755\\
Vonovia & VNA.DE & 52.4410 & 0.0714 & 0.0801 & 0.0662 & 0.1222 & 1 & 0.0593\\
Volkswagen Vz & VOW3.DE & 177.7200 & 0.0615 & 0.0615 & 0.1207 & 0.1521 & 2 & 0.1181\\
Zalando & ZAL.DE & 89.9610 & 0.0656 & 0.0656 & 0.1139 & 0.2111 & 2 & 0.0600\\
\bottomrule
\end{tabular}
\caption{}
\end{table}
...
reinforcement learning\opt{short}{~\citep{SB18,PGL17}}.

\acks{
We would like to thank Chad Clark, Andrew Francis, Rouven Neitzel, Oliver Otto,
Kai Steckhan, Flora Stolzenburg, and Ruben Zilibowitz for helpful discussions
...
A short and preliminary version of this paper was presented at the conference
