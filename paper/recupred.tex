...
for the RMSE of $\theta = 1$\,m,\marginpar{???} and only use every $20^\text{th}$ step of each of the
...
\begin{figure}
\centering
\includegraphics[width=0.43\columnwidth]{fig/game6} % 30.48x20.32
\hfill %
\includegraphics[width=0.2\columnwidth]{fig/goalie}     % 3450x4373. (23)
\hfill %
\includegraphics[width=0.35\columnwidth]{fig/goalievisits} % 5717x4437 (38)
