...
and this is probably \todo[inline]{skip probably?} 
the main contribution of this article, the size of an
...
Train + test time & 0.35s & 3.2 s & 1.24 s & 125.43 s & 2.97 s \\ \bottomrule
\end{tabular}
