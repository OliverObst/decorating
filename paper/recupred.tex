...
steps as test data and compare the performance of LRNNs with other approaches
(cf. \cref{related}) with respect to their RSME on the test data, partially
...
the network size reduction procedure (cf. \cref{reduce}), because it exactly
selects the relevant components of the network: Each complex conjugate
...
\begin{sidewaystable}
  ...
  \begin{tabular}{c*{8}{p{8mm}}cccc@{\,+\,}cccc}
	...
	12 & 0.036 & 0.052 & 0.062 & 0.222 & 0.279 & 0.316 & 0.563 & 0.672 & 1.52224 & 1.83523 & 0.18562 & 10 & 8 & 0.15571 & 14 & \textbf{0.15984}\\
...
We analyze 30 different stocks using the closing stock prices 2016--2019 from
\url{http://de.finance.yahoo.com/} and compare their ARIMA prediction with
