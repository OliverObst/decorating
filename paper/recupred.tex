...
\author{Frieder Stolzenburg$^{1}$, Sandra Litz$^{1}$, Olivia Michael$^{2}$, and Oliver Obst$^{2}$}
...
\address{$^{1}$Faculty of Automation and Computer Sciences, Harz University of Applied Sciences,\\
         Friedrichstr.~57-59, 38855~Wernigerode, Germany\\
         $^{2}$Centre for Research in Mathematics and Data Science, Western Sydney University,\\
